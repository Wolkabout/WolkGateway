...
TEST_F(DeviceRegistrationService, Given_ThatNoDeviceIsRegistered_When_DeviceOtherThanGatewayRequestsRegistration_Then_RegistrationRequestIsNotForwardedToPlatform)
{
    ...
    auto deviceRegistrationRequestMessage = wolkabout::DeviceRegistrationProtocol::makeDeviceRegistrationRequestMessage(GATEWAY_KEY, deviceKey, deviceRegistrationRequest);
...
TEST_F(DeviceRegistrationService, Given_ThatNoDeviceIsRegistered_When_GatewayRequestsRegistration_Then_RegistrationRequestIsForwardedToPlatform)
{
    ...
    auto gatewayRegistrationRequestMessage = wolkabout::DeviceRegistrationProtocol::makeDeviceRegistrationRequestMessage(GATEWAY_KEY, GATEWAY_KEY, gatewayRegistrationRequest);
...
TEST_F(DeviceRegistrationService, Given_GatewayRegistrationAwaitingPlatformResponse_When_DeviceIsSuccessfullyRegistered_Then_OnDeviceRegisteredCallbackIsInvoked)
{
    ...
    auto gatewayRegistrationResponseMessage = wolkabout::DeviceRegistrationProtocol::makeDeviceRegistrationResponseMessage(GATEWAY_KEY, GATEWAY_KEY, gatewayRegistrationResponse);
...
TEST_F(DeviceRegistrationService, Given_DeviceRegistrationAwaitingPlatformResponse_When_DeviceIsSuccessfullyRegistered_Then_OnDeviceRegisteredCallbackIsInvoked)
{
    ...
    auto deviceRegistrationResponseMessage = wolkabout::DeviceRegistrationProtocol::makeDeviceRegistrationResponseMessage(GATEWAY_KEY, deviceKey, deviceRegistrationResponse);
       ...
       Given_RegisteredGatewayAndChildDevice_When_DeviceReregistrationRequestIsReceived_Then_DeviceReregistrationRequestIsForwardedToChildDevice)
{
    ...
    // When
    auto reregisterAllDevicesRequestMessage = wolkabout::DeviceRegistrationProtocol::makeDeviceReregistrationRequestForGateway(GATEWAY_KEY);
