 ...
 * handle_openssl_init - if mqtt library should handle openssl init (1) or rely on the caller to init it before using
 * mqtt (0)
 */
 ...
 */
DLLExport int MQTTAsync_create(MQTTAsync* handle, const char* serverURI, const char* clientId, int persistence_type,
...
#define MQTTAsync_connectOptions_initializer                                                                       \
    {                                                                                                              \
        {'M', 'Q', 'T', 'C'}, 5, 60, 1, 10, NULL, NULL, NULL, 30, 0, NULL, NULL, NULL, NULL, 0, NULL, 0, 0, 1, 60, \
        {                                                                                                          \
            0, NULL                                                                                                \
        }                                                                                                          \
    }
...
/**
  ...
  * subscriptions.
  */
DLLExport int MQTTAsync_subscribeMany(MQTTAsync handle, int count, char* const* topic, int* qos,
...
/**
  ...
  */
DLLExport int MQTTAsync_unsubscribeMany(MQTTAsync handle, int count, char* const* topic,
                                        MQTTAsync_responseOptions* response);
...
* @page tracing Tracing
  ...
  * @code
    20130528 161819.657 Allocating 16 bytes in heap at file /home/icraggs/workspaces/mqrtc/mqttv3c/src/MQTTPacket.c line
177 ptr 0x179f930

    20130528 161819.657 Freeing 16 bytes in heap at file /home/icraggs/workspaces/mqrtc/mqttv3c/src/MQTTPacket.c line
201, heap use now 896 bytes
  * @endcode
  ...
  * @code
    ...
    20130528 163909.208 Heap element size 32, line 354, file /home/icraggs/workspaces/mqrtc/mqttv3c/src/MQTTPacket.c,
ptr 0x260cb00
