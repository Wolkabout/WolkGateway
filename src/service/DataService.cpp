...
{
    const std::string topicGwPart =
      Channel::ACTUATION_SET_TOPIC_ROOT + Channel::GATEWAY_PATH_PREFIX + m_gatewayKey + Channel::CHANNEL_DELIMITER;
...
void DataService::addSensorReadings(std::vector<std::shared_ptr<SensorReading>> sensorReadings)
{
    ...
    std::string topic = Channel::SENSOR_READING_TOPIC_ROOT + Channel::GATEWAY_PATH_PREFIX + m_gatewayKey +
                        Channel::CHANNEL_DELIMITER + sensorReadings.front()->getReference();
...
void DataService::addAlarms(std::vector<std::shared_ptr<Alarm>> alarms)
{
    ...
    std::string topic = Channel::EVENTS_TOPIC_ROOT + Channel::GATEWAY_PATH_PREFIX + m_gatewayKey +
...
{
    std::string topic = Channel::ACTUATION_STATUS_TOPIC_ROOT + Channel::GATEWAY_PATH_PREFIX + m_gatewayKey +
                        Channel::CHANNEL_DELIMITER + actuatorStatus->getReference();
...
void DataService::routeModuleMessage(const Message& message, const std::string& topicRoot)
{
    ...
    std::string routedPath =
      topicRoot + Channel::GATEWAY_PATH_PREFIX + m_gatewayKey + Channel::CHANNEL_DELIMITER + topicRefPath;
