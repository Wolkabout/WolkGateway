...
public:
    ...
    {
        return std::make_shared<message>(std::move(topic), payload, len, DFLT_QOS, DFLT_RETAINED);
    }
    /**
     * Constructs a message from a byte buffer.
     * Note that the payload accepts copy or move semantics.
    ...
    {
        return std::make_shared<message>(std::move(topic), std::move(payload), qos, retained);
    }
    /**
     * Constructs a message from a byte buffer.
     * Note that the payload accepts copy or move semantics.
     ...
     */
    void set_topic(string_ref topic) { topic_ = topic_ ? std::move(topic) : string_ref(string()); }
    /**
 ...
 * @param retained Whether the message should be retained by the broker.
 */
inline message_ptr make_message(string_ref topic, const void* payload, size_t len, int qos, bool retained)
{
 ...
 * @param retained Whether the message should be retained by the broker.
 */
inline message_ptr make_message(string_ref topic, binary_ref payload, int qos, bool retained)
{
