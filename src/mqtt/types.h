 ...
 */
template <class Rep, class Period> std::chrono::seconds to_seconds(const std::chrono::duration<Rep, Period>& dur)
{
 ...
 */
template <class Rep, class Period> long to_seconds_count(const std::chrono::duration<Rep, Period>& dur)
{
 ...
 */
template <class Rep, class Period> long to_milliseconds_count(const std::chrono::duration<Rep, Period>& dur)
{
