...
{
    std::string topic = Channel::ACTUATION_SET_TOPIC_ROOT + Channel::GATEWAY_PATH_PREFIX + m_gatewayKey +
                        Channel::CHANNEL_DELIMITER + Channel::CHANNEL_WILDCARD;
    m_subscriptionList.emplace_back(topic);

    topic = Channel::ACTUATION_GET_TOPIC_ROOT + Channel::GATEWAY_PATH_PREFIX + m_gatewayKey +
            Channel::CHANNEL_DELIMITER + Channel::CHANNEL_WILDCARD;
    m_subscriptionList.emplace_back(topic);

    topic = Channel::CONFIGURATION_SET_REQUEST_TOPIC_ROOT + Channel::GATEWAY_PATH_PREFIX + m_gatewayKey +
            Channel::CHANNEL_DELIMITER + Channel::CHANNEL_WILDCARD;
    m_subscriptionList.emplace_back(topic);

    topic = Channel::CONFIGURATION_GET_REQUEST_TOPIC_ROOT + Channel::GATEWAY_PATH_PREFIX + m_gatewayKey +
            Channel::CHANNEL_DELIMITER + Channel::CHANNEL_WILDCARD;
    m_subscriptionList.emplace_back(topic);

    topic = Channel::DEVICE_REGISTRATION_RESPONSE_TOPIC_ROOT + Channel::GATEWAY_PATH_PREFIX + m_gatewayKey +
            Channel::CHANNEL_DELIMITER + Channel::CHANNEL_WILDCARD;
    m_subscriptionList.emplace_back(topic);

    topic = Channel::DEVICE_REREGISTRATION_REQUEST_TOPIC_ROOT + Channel::GATEWAY_PATH_PREFIX + m_gatewayKey +
            Channel::CHANNEL_DELIMITER + Channel::CHANNEL_WILDCARD;
    m_subscriptionList.emplace_back(topic);
}
