...
const std::string Channel::LAST_WILL_TYPE = "lastwill";
...
const std::string Channel::DEVICE_STATUS_REQUEST_TOPIC_ROOT =
  PLATFORM_TO_DEVICE_DIRECTION + CHANNEL_DELIMITER + DEVICE_STATUS_TYPE + CHANNEL_DELIMITER;
const std::string Channel::DEVICE_STATUS_RESPONSE_TOPIC_ROOT =
...
const std::string Channel::LAST_WILL_TOPIC_ROOT = LAST_WILL_TYPE + CHANNEL_DELIMITER;
